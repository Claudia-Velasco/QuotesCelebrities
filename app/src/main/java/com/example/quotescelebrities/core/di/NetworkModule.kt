...
import com.example.quotescelebrities.data.remote.QuoteApiInterface
import com.example.quotescelebrities.data.remote.QuoteRemoteDataSourceImpl
import com.example.quotescelebrities.data.remote.UserApiInterface
...
object NetworkModule {
    ...
    // With ngrok use the command ./ngrok http <PortNumber>
    // ./ngrok http 8080 ->//"https://5bdd-186-96-178-138.ngrok.io"
